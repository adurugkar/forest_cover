...
class Configuration:
    ...
    def get_data_ingestion_config(self)-> DataIngestionConfig:
        try:
            ...
            data_ingestion_config = DataIngestionConfig(
                ...
                ingested_data_dir = ingested_train_dir,
    ...
    def get_training_pipline_config(self)-> TrainingPipelineConfig:
        try:
            train_pipline_config = self.config_info[TRANING_PIPELINE_CONFIG_KEY]
            artifact_dir = os.path.join(ROOT_DIR,
                    train_pipline_config[TRANING_PIPELINE_NAME_KEY],
                    train_pipline_config[TRANING_PIPELINE_ARTIFACT_DIR_KEY])
                
            training_pipline_config = TrainingPipelineConfig(artifact_dir = artifact_dir)
            logging.info(f"Training pipeline config : {train_pipline_config}")
